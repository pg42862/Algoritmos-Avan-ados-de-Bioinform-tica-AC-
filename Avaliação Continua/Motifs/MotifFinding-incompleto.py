...
def test1():  
    sm = MotifFinding()
    sm.readFile("C:/Users/rafes/Documents/GitHub/Algoritmos-Avan-ados-de-Bioinform-tica-AC-/Avaliação Continua/exemploMotifs.txt", "dna")
    sol = [25,20,2,55,59]
    sa = sm.score(sol)
    print(sa)
...
def test3():
    mf = MotifFinding()
    mf.readFile("C:/Users/rafes/Documents/GitHub/Algoritmos-Avan-ados-de-Bioinform-tica-AC-/Avaliação Continua/exemploMotifs.txt","dna")
    print ("Branch and Bound:")
